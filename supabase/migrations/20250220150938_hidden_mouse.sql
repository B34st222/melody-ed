/*
  # Fix guest login and policies

  1. Changes
    - Recreate guest user with proper configuration
    - Update RLS policies to handle guest access correctly
    - Add system-owned playlists and songs for guest access

  2. Security
    - Guest user has read-only access
    - Regular users can manage their own content
    - System content is readable by all users
*/
...
BEGIN
  ...
  VALUES
    ('e290f1ee-6c54-4b01-90e6-d701748f0851', 'Multiplication Rap', 'Math Masters', 'https://images.unsplash.com/photo-1509228468518-180dd4864904?w=800', 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', 'Mathematics', '7-10', system_user_id),
    ('e290f1ee-6c54-4b01-90e6-d701748f0852', 'Addition Adventure', 'Number Ninjas', 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800', 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', 'Mathematics', '6-8', system_user_id),
    ('e290f1ee-6c54-4b01-90e6-d701748f0853', 'The Solar System Song', 'Science Kids', 'https://images.unsplash.com/photo-1507413245164-6160d8298b31?w=800', 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', 'Science', '8-12', system_user_id),
    ('e290f1ee-6c54-4b01-90e6-d701748f0854', 'States of Matter', 'Lab Rats', 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=800', 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', 'Science', '9-11', system_user_id),
    ('e290f1ee-6c54-4b01-90e6-d701748f0855', 'Phonics Fun', 'Reading Rangers', 'https://images.unsplash.com/photo-1524578271613-d550eacf6090?w=800', 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', 'Language Arts', '5-8', system_user_id);
